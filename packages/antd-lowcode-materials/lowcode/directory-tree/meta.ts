...
const DirectoryTreeMeta: ComponentMetadata = {
  ...
  "devMode": "proCode",
  "npm": {
    "package": "@dslc/antd-lowcode-materials",
    "version": "1.1.9",
    "exportName": "Tree",
    "main": "src/index.tsx",
    "destructuring": true,
    ...
    "props": [
      ...
      },
      {
        "title": {
          ...
          "tip": "autoExpandParent"
        },
        "name": "autoExpandParent",
        "description": "autoExpandParent",
        "setter": {
          "componentName": "MixedSetter",
          "props": {
            "setters": [
      ...
      },
      {
        "title": {
          ...
          "tip": "Node selection in Checkable state is fully controlled (the selected state of parent and child nodes is no longer associated)"
        },
        "name": "checkStrictly",
      ...
      },
      {
        "title": {
          ...
          "tip": "defaultExpandAll"
        },
        "name": "defaultExpandAll",
        "description": "defaultExpandAll",
        "setter": {
          "componentName": "MixedSetter",
          "props": {
            "setters": [
      ...
      },
      {
        "title": {
          ...
          "tip": "defaultExpandParent"
        },
        "name": "defaultExpandParent",
        "description": "defaultExpandParent",
        "setter": {
          "componentName": "MixedSetter",
          "props": {
            "setters": [
      ...
      },
      {
        "title": {
          ...
          "tip": "defaultExpandedKeys"
        },
        "name": "defaultExpandedKeys",
        "description": "defaultExpandedKeys",
        "setter": {
          "componentName": "MixedSetter",
          "props": {
            "setters": [
      ...
      },
      {
        "title": {
          ...
          "tip": "defaultCheckedKeys"
        },
        "name": "defaultCheckedKeys",
        "description": "defaultCheckedKeys",
        "setter": {
          "componentName": "MixedSetter",
          "props": {
            "setters": [
      ...
      },
      {
        "title": {
          ...
          "tip": "defaultSelectedKeys"
        },
        "name": "defaultSelectedKeys",
        "description": "defaultSelectedKeys",
        "setter": {
          "componentName": "MixedSetter",
          "props": {
            "setters": [
      ...
      },
      {
        "title": {
          ...
          "tip": "Set the node to be draggable (ie>8)"
        },
        "name": "draggable",
